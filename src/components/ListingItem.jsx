  ...
  return (
    <li className="categoryListing">
      <Link to={`/category/${listing.type}/${id}`} className="categoryListingLink">
        ...
        <div className="categoryListingDetails" style={onDelete && onEdit && {'paddingRight':'60px'}}>
      ...
      {onDelete && (<DeleteIcon className='removeIcon' fill='rgba(231,76,60)' onClick={() => onDelete(listing.id, listing.name)} />)}
