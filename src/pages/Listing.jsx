  ...
  return (
    <main>
      ...
      <Swiper slidesPerView={1} pagination={{clickable: true}}>
        {listing.imageUrls.map((url, index) => (
          <SwiperSlide key={index}>
            <div className="swiperSlideDiv" style={{background: `url(${listing.imageUrls[index]}) center no-repeat`, backgroundSize: 'cover'}}>
      ...
      <div className="listingDetails">
        ...
        <p className="listingL">{listing.location}</p>
        ...
        <ul className="listingDetailsList">
          ...
          <li>{listing.bathrooms > 1 ? `${listing.bedrooms} Bathrooms` : '1 Bathroom'}</li>
...
// https://stackoverlow.com/questions/67552020/how-to-fix-error-failed-to-compile-mode-modules-react-leaflet-core-esm-pat